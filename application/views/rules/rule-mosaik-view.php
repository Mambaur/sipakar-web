...
<div class="container-fluid">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Rule Mosaik Tembakau</li>
  </ol>
  ...
  <form action="" method="post">
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        Data Rules Penyakit Mosaik Tembakau</div>
      <div class="card-body">
        <div class="table-responsive">
            ...
            <a href="<?= base_url();?>rules?indication=mosaik" class="btn btn-success ml-1 mb-2">Mosaik</a>
          </tbody>
            </table>
        </div>
      </div>
